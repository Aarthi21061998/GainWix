  ...
  return (
    <div
      className={cn(
        `lg:pt-14 pb-10 flex items-center ${
          revers
            ? "min-[992px]:!flex-row-reverse gap-[15vw] max-[992px]:!flex-col"
            : "gap-[2.5vw] !flex-row !justify-between max-[992px]:!flex-col"
        }`,
        className
      )}
      {...restProps}
    >
      ...
      >
        ...
        {content && (
          <p
            className={`md:text-lg font-medium text-[#3B3F46] mt-5 mb-7 text-left md:w-[80vw] xs:w-[80vw] xs:text-[3vw] lg:w-full ${
              revers
        ...
        {list && (
          <div className={`w-full ${text ? "mt-[1vw]" : ""}`}>
            {list.map((data) => (
              <div
                className="flex items-center gap-[0.8vw] py-3"
              ...
              >
                {text ? (
                  <div className="flex flex-col">
                    ...
                    <p className="pl-[1.8vw] xs:leading-1 md:leading-7 lg:w-[35vw] md:w-[80vw] lg:text-[0.95vw] md:text-[1.5vw] font-medium text-[#908EB5] md:mt-3 xs:text-[3vw] xs:w-[80vw]">
                      {data.content}
                    </p>
                  </div>
                ) : (
                  <div className="flex lg:text-lg font-medium align-center">
                    {/* <img src={ICONS?.BulletPoint} alt="list icon" /> */}
                    <p className="pl-[1.8vw] xs:leading-1 md:leading-7 md:w-[70vw] lg:w-[35vw] xl:text-[0.95vw] md:text-[1.5vw] font-medium text-[#3B3F46] md:mt-3 xs:text-[3vw] xs:w-[80vw]">
                      {data.content}
                    </p>
                  </div>
                )}
