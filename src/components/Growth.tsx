      ...
      <div className="relative">
        ...
        <div className="absolute xl:top-[12vw]  md:top-[7vw] text-[white] xs:top-[-5vw] xs:left-[20vw] ">
          <div className="py-20 flex flex-col align-center items-center justify-center xs:w-full xs:max-w-[60vw] xs:justify-center xs:items-center xs:text-center xl:mt-[4vw]">
            ...
            <p className=" xs:hidden  lg:block font-Inter fond-semibold xs:text-[3vw] lg:text-[1.55vw] xl:text-[1.2vw] xs:px-5  text-[#908EB5] lg:mt-4 lg:mx-0 xs:mt-2">
              <p className="xl:w-[48vw] xl:pl-10  lg:pl-0 lg:w-[55vw]  md:w-[95vw] xs:w-[95vw] ">
                Leverage Gainwix.ai as your all-in-one platform to streamline
                your operations and keep
              </p>
              <p className=" xl:w-[55vw] lg:w-[50vw] md:w-[98vw] md:px-[1vw]  ">
            ...
            <div className="border border-[#2D3154] rounded-full lg:min-w-[30vw] w-auto lg:max-h-[10vh] xs:w-[95vw] sm:w-full  justify-between flex flex-row h-auto lg:p-3 xs:p-2 md:p-4 lg:m-5 xs:m-2 items-center  xl:mb-[20vw]">
              ...
              <div className="btn btn_primary items-center ">
                <p className="2xl:mt-[2px] xs:mt-[7px] lg:mt-2 md:mt-1 font-Inter font-medium lg:text-[1vw] xs:text-[3vw] md:text-[2vw] ">
                  Book a Demo
                </p>
              </div>
            </div>
